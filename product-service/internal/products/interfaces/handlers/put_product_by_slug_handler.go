...
// PutProductBySlugHandler godoc
// @Summary      Update product by slug
// @Description  Updates an existing product by its slug for the given vendor.
// @Tags         products
// @Accept       json
// @Produce      json
...
// @Router       /products/slug/{slug} [put]
func (h *ProductHandler) PutProductBySlugHandler(c *gin.Context) {

	ctx, span := tracer.Tracer.Start(c.Request.Context(), "PutProductBySlugHandler")
	defer span.End()
	...
	if err := services.PutProductBySlug(ctx, h.ProductRepo, h.EventRepo, h.Db, slug, productReq, vendorId); err != nil {
